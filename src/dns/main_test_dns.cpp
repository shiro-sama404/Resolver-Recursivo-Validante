...
//         CacheCommand cmd = args.get_cache_command();

//         if (cmd == CacheCommand::Activate) 
//         {
...
//             return 0;
//         } 
//         else if (cmd == CacheCommand::Status) 
//         {
//             CacheDaemon::send_command("STATUS");
//             return 0;
//         } 
//         else if (cmd == CacheCommand::PurgeAll) 
//         {
//             CacheDaemon::send_command("PURGE_ALL");
//             return 0;
//         } 
//         else if (cmd == CacheCommand::Deactivate) 
//         {
