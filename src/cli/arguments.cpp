...
void Arguments::print_usage(const char* prog)
{
    cerr << "Uso: " << prog << endl
         ...
         << "[--cache-put <n> <v> <t> | --cache-put-negative <n> <v> <t>]" << endl
         << "[--cache-get <n> | --cache-get-negative <n>]" << endl;
}
...
void Arguments::parse(int argc, char* argv[])
{
    constexpr option long_options[] = {
        ...
        {"cache-put-negative", required_argument, nullptr, 1012},
        {"cache-get"         , required_argument, nullptr, 1013},
        {"cache-get-negative", required_argument, nullptr, 1014},
    ...
    while ((opt = getopt_long(argc, argv, "", long_options, &option_index)) != -1)
    {
        ...
        {
            // parâmetros DNS
            case 'n': _ns           = optarg;                 _hasDNSArgs = true; break;
            case 'd': _name         = optarg;                 _hasDNSArgs = true; break;
            case 'q': _qtype        = optarg;                 _hasDNSArgs = true; break;
            case 'm': _mode         = string_to_mode(optarg); _hasDNSArgs = true; break;
            case 's': _sni          = string(optarg);         _hasDNSArgs = true; break;
            case 't': _trust_anchor = string(optarg);         _hasDNSArgs = true; break;
            case 'f': _fanout       = stoi(optarg);           _hasDNSArgs = true; break;
            case 'w': _workers      = stoi(optarg);           _hasDNSArgs = true; break;
            case 'o': _timeout      = stoi(optarg);           _hasDNSArgs = true; break;
            case 'r': _trace        = true;                   _hasDNSArgs = true; break;
            ...
            case 1012: _cacheCommand = CacheCommand::CachePutNegative; break;
            case 1013: _cacheCommand = CacheCommand::CacheGet;         break;
            case 1014: _cacheCommand = CacheCommand::CacheGetNegative; break;
            default:
                print_usage(argv[0]);
